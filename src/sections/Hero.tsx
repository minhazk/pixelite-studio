...
export default function Hero({ setEmailInput }: { setEmailInput: Dispatch<SetStateAction<string>> }) {
    ...
    return (
        <motion.div animate={{ opacity: 1 }} initial={{ opacity: 0 }} transition={{ delay: 0.2, duration: 1, ease: 'easeInOut' }} className='text-center pt-3 md:pt-8 pb-16 px-8 max-w-2xl mx-auto'>
